...
function MensFashion() {
    ...
    const { cartItem, addToCart, quantities, setQuantities } = useCart();
    ...
    return (
        <>
            ...
            <div className='text-center mx-5' id='mensFashion'><h1>Men's Fashion</h1><hr /></div>
                            ...
                            <div className="product-item bg-light mb-4 ml-2">
                                <div className="product-img position-relative overflow-hidden">
                                    ...
                                    <div className="product-action" >
                                        <Link className="btn btn-outline-dark btn-square" to={`ShopDetailPage/${data.ProductName}`}  >learn More</Link>
                                        <Link
