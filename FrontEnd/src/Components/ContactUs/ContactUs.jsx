...
function ContactUs() {
    ...
    const { user, formData, userName } = useCart()
                ...
                <div className="row px-xl-5">
                    ...
                    <div className="col-lg-5 mb-5">
                        ...
                        <div className="bg-light p-30 mb-3">
                            <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3"></i>123 Street, Addis Ababa, Ethiopia</p>
                            <p className="mb-2"><i className="fa fa-envelope text-primary mr-3"></i>sura@gmail.com</p>
